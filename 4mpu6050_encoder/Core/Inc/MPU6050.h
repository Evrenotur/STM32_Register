...
#define INC_MPU6050_H_
							          //Kullandiginiz kartin temel header dosyasini yazmalisiniz, burada "stm32f4xx.hal.h" dir.
#include "stm32f4xx_hal.h"        //You can choose which STM32 family you are using
#include <math.h>
...
extern I2C_HandleTypeDef hi2c2; // Kullandiginiz I2C birimini girmelisiniz. Örn; hi2c1, hi2c2....
#define I2C_UNIT2 &hi2c2			// Kullandiginiz I2C birimini girmelisiniz. Örn; &hi2c1, &hi2c2....
extern I2C_HandleTypeDef hi2c3; // Kullandiginiz I2C birimini girmelisiniz. Örn; hi2c1, hi2c2....
#define I2C_UNIT3 &hi2c3
#define MPU6050_ADDRESS  0x68<<1 // 7 Bit I2C modu kullanildigi icin 8 bitlik adres 1 bit sola otelenmistir
#define MPU6050_ADDRESS2  0X69<<1 // VCC Bağlı
typedef enum{
	SMPRT_DIV		=	0x19,
	CONFIG			=	0x1A,
	GYRO_CONFIG	 	=	0x1B,
